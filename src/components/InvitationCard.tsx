      ...
      return (
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl sm:text-5xl font-extrabold tracking-wide text-amber-200 capitalize">
      ...
      return (
        ...
        >
          ...
          <motion.div variants={itemVariants} className="my-6">
            <h1 className="text-4xl sm:text-6xl font-normal tracking-wide text-yellow-300 font-serif italic">
              <TypewriterText text={groomName || "Groom Name"} enabled={enableTypewriter} delay={300} />
            </h1>
    ...
    case 'floral':
      return (
        ...
        >
          ...
          {/* Couple Names */}
          <motion.div variants={itemVariants} className="my-6">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-[#4A3B32] font-serif capitalize tracking-wide">
      ...
      return (
        ...
        >
          ...
          <motion.div variants={itemVariants} className="my-10 space-y-2">
            <h1 className="text-4xl sm:text-5xl font-light tracking-widest text-neutral-950 uppercase font-serif">
              <TypewriterText text={groomName || "GROOM"} enabled={enableTypewriter} delay={300} />
            </h1>
    ...
    default:
      return (
        ...
        >
          ...
          {/* Couple Names */}
          <motion.div variants={itemVariants} className="my-6">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-[#704235] font-serif capitalize">
              <TypewriterText text={groomName || "Groom Name"} enabled={enableTypewriter} delay={300} />
            </h1>
